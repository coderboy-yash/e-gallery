...
function Gallery() {
  ...
  return (
    <div className="App">
      ...
      >
        <h1 className="text-white flex justify-end items-center p-10 mr-32 gap-4 drop-shadow-lg shadow-yellow-500">
          Welcome <span>{user.name}</span>
        </h1>
        <h2>
          put all your images from various platforms like insta, unsplash, web,
          your pc or any other place at one place.
        </h2>
        <h3> upload your image and get a sharable link.</h3>
      </div>
