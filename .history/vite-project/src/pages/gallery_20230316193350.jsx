...
function Gallery() {
  ...
  return (
    <div className="App">
      ...
      >
        {" "}
        <div className="text-white flex flex-col  justify-center items-center ml-[40rem] mt-40 w-96  gap-8 drop-shadow-lg shadow-yellow-500">
          <h1 className="text-[4rem] capitalize">
