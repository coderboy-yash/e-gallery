...
function Gallery() {
  ...
  return (
    <div className="App">
      ...
      >
        {" "}
        <div className="text-white flex flex-col  justify-center items-center ml-[40rem] mt-40 w-[10rem]  gap-4 drop-shadow-lg shadow-yellow-500">
          <h1 className="text-[3rem] capitalize mb-8">
          ...
          <h3>
            {" "}
            upload your images in your{" "}
            <span className="text-yellow-300 ">e-gallery</span> and get a
            sharable link.
          </h3>
        </div>
      </div>
