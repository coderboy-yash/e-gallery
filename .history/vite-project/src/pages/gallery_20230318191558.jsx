  ...
  return (
    <div className="App">
      ...
      >
        ...
        <div className="text-white flex flex-col  justify-center items-center m-auto mt-[50rem]  md:mt-40 md:ml-[40rem] w-[25rem]  gap-4 drop-shadow-lg shadow-yellow-500">
