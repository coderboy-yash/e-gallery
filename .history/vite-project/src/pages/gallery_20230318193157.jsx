  ...
  return (
    <div className="App">
      ...
      >
        ...
        <div className="text-white flex flex-col  justify-center items-center m-auto mt-[5rem]  md:mt-40 md:ml-[40rem] w-[25rem]  gap-8 p-6 drop-shadow-lg shadow-yellow-500">
          <h1 className="text-[3rem]  mb-64 border-b-2 border-b-amber-300">
      ...
      <div className="images-preview-container m-auto">
        ...
        <div className="flex flex-wrap justify-center gap-3 p-4 items-end">
