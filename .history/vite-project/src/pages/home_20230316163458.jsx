...
const Home = () => {
  ...
  return (
    <div className="flex border-red-200 border-8 p-6 h-96">
      <div className="h-screen w-[40rem] bg-gradient-to-b from-amber-100 to-lime-50 justify-center items-center flex flex-col ">
