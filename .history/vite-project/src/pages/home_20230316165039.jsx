...
const Home = () => {
  ...
  return (
    <div className="flex border-red-200 border-8 p-6 h-screen bg-gradient-to-b from-orange-800 to-orange-300">
      <div className="h-[33rem] w-[40rem] bg-gradient-to-b from-amber-100 to-lime-50  items-center flex flex-col shadow-md shadow-red-500 ">
        <h1 className="p-10 text-5xl mb-4">Welcome to your e-gallery</h1>
