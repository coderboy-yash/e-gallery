...
const Home = () => {
  ...
  return (
    <div className="flex flex-wrap  border-green-500 border-8 p-6 bg-gradient-to-b from-emerald-400 to-teal-200">
      <div
        className="h-[33rem]  bg-gradient-to-br from-green-200 to-teal-100 w-screen sm:w-1/2   items-center flex flex-col  p-4
      ...
      >
        <h1 className="p-5 text-4xl mb-16 bg-green-400 rounded-md text-white mt-10 ">
