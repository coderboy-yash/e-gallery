    ...
    >
      <div className="h-screen w-3/4  m-auto flex justify-center p-10 ">
        <form
          ...
          className="flex flex-col justify-center items-center bg-white gap-10 m-8 p-10 rounded-sm "
        >
          <h1>register Here</h1>
          <input
            className="p-2 outline-orange-300 border-orange-900 border-2"
            type="name"
            placeholder="name"
          ...
          />
          <button
            className="p-2 outline-orange-300 border-orange-900 border-2 w-60 bg-amber-900 text-white"
            type="submit"
          >
            submit
          </button>
